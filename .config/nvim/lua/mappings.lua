...
--   utils.ShowDocs()
-- end, { desc = "LSP hover" })
-- map("n", "Md", "<Plug>(coc-diagnostic-prev)", { desc = "Go to previous diagnostic message" })
-- map("n", "md", "<Plug>(coc-diagnostic-next)", { desc = "Go to next diagnostic message" })
-- -- map("n", "<leader>de", vim.diagnostic.open_float, { desc = "Open floating diagnostic message" })
-- map("n", "<leader>e", ":<C-u>CocList diagnostics<cr>", { desc = "Open floating diagnostic message" })
-- -- map("n", "<leader>dq", vim.diagnostic.setloclist, { desc = "Open diagnostics list" })
-- -- map("n", "<leader>dws", function()
-- --   vim.lsp.buf.workspace_symbol()
-- -- end, { desc = "Workspace Symbols" })
-- map("n", "<leader>.", ":Telescope coc code_actions<CR>", { desc = "Code Action" })
-- map("n", "gr", "<Plug>(coc-references)", { desc = "References" })
-- map("n", "gd", "<Plug>(coc-definition)", { desc = "Definition" })
-- map("n", "<leader>ra", "<Plug>(coc-rename)", { desc = "Rename" })
